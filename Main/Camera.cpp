...
CCamera::CCamera() // OK
{
	...
	this->m_Address.Zoom = (float*)0x00660390;

	this->m_Address.RotX = (float*)0x07AFE994;

	this->m_Address.RotY = (float*)0x00758A30;

	this->m_Address.PosZ = (float*)0x00757994;

	this->m_Address.ClipX[0] = (float*)0x007588B4;

	this->m_Address.ClipX[1] = (float*)0x007588C0;

	this->m_Address.ClipY[0] = (float*)0x00608347;

	this->m_Address.ClipY[1] = (float*)0x006081B3;

	this->m_Address.ClipGL = (float*)0x006606B8;

	this->m_Default.IsLoad = 0;

	SetCompleteHook(0xE9,0x006435AF,&RotateDamageAngle);
}
...
{
	static DWORD RotateDamageAngleAddress1 = 0x006434D1;
