...
int CCustomItemBow::GetCustomItemBowEffect(int ItemIndex)
{
	...
	int SkillEffects[16] = { 252, 253, 254, 255, 256, 257, 258, 259, 260, 280, 281, 282, 283, 304, 307, 318 };

	return SkillEffects[lpInfo->Effect];
}

int CCustomItemBow::CheckCustomItemBow(int ItemIndex,eBowType Type)
{
	CUSTOM_ITEM_BOW_INFO* lpInfo = this->GetInfoByItem(ItemIndex);

	if(lpInfo == 0 || lpInfo->Type != Type)
	{
		return 0;
	}
