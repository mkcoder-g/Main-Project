...
void InitLanguage() // OK
{
	...
	SetDword(0x0063E9C5,(DWORD)&filename[0]);
	SetDword(0x0063E984,(DWORD)&filename[1]);
	SetDword(0x00496EB3,(DWORD)&filename[2]);
	SetDword(0x00459965,(DWORD)&filename[3]);
	SetDword(0x004599CB,(DWORD)&filename[4]);
	SetDword(0x0063E9EA,(DWORD)&filename[5]);
	SetDword(0x0063EA44,(DWORD)&filename[6]);
	SetDword(0x0063E9D2,(DWORD)&filename[7]);
	SetDword(0x0063E991,(DWORD)&filename[8]);
	SetDword(0x0063EA61,(DWORD)&filename[9]);
	SetDword(0x0063EBB1,(DWORD)&filename[10]);
}